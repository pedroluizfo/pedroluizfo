...
**Currently:** Full Stack Developer at UNIE (since Jan 2025). I was the first developer hired: I took a poorly structured legacy codebase to a stable product running in production, helped design the infrastructure, worked with the business team on requirements and product vision, and helped hire the development team.

#### Tech

JavaScript · TypeScript · React · Node.js · Python · Java · C# · C · SQL · Docker · Git · Linux
